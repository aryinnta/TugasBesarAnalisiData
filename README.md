...
## 🎯 Tujuan
1. Menganalisis tren perkembangan jumlah kasus HIV di Jawa Barat dari tahun ke tahun.  
2. Mengidentifikasi daerah dengan jumlah kasus HIV tertinggi dan terendah.  
3. Mengembangkan model prediksi jumlah kasus HIV menggunakan Support Vector Regression (SVR).  
4. Menyajikan hasil analisis dan prediksi dalam bentuk dashboard interaktif.
